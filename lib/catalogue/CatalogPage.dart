...
class CatalogPage extends StatefulWidget{
  ...
  CatalogPage(this.id, this.type, this.collection);
  _CatalogPageState createState() => _CatalogPageState(this.id, this.type, this.collection);
}
...
class _CatalogPageState extends State<CatalogPage>{
  ...
  _CatalogPageState(this.id, this.type, this.collection);
  ...
  getService(){
    Firestore.instance.collection("home_services").doc(id).collection('types').getDocuments().then((value) => {
      print('types fetched')
    });
  }
        ...
        child: Column(
          ...
          children: [
            FutureBuilder<QuerySnapshot>(
                ...
                future: Firestore.instance.collection(collectionName).doc(id).collection('types').get(),
